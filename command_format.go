...
*/
func format(
	fp, extension, code string, isCodeInput, isRegionInput bool, config TConfig, regexps TRegexps, specialCases TSpecialCases, orderList TOrderList, groupNameList []string, wg *sync.WaitGroup, isAsync bool,
) {
	var (
		err        error
