...
const mergeLists: MergeList[] = [
	...
	{ include: ["-col-"], exclude: ["-columns-", "-column-", "-cols-"], regex: ["-row", "-row-", "-col", "-col-"] },
	{ include: ["-right-top", "-right-bottom", "-left-bottom", "-left-top"], exclude: ["-down", "-end", "-footer"], regex: ["-none", "-initial", "-auto", "-both", "-center", "-top", "-right-top", "-right", "-right-bottom", "-bottom", "-left-bottom", "-left", "-left-top", ...customs] },
	{ include: ["-top-right", "-top-left", "-bottom-right", "-bottom-left"], exclude: ["-down", "-end", "-footer"], regex: ["-none", "-initial", "-auto", "-both", "-center", "-top", "-top-right", "-right", "-bottom-right", "-bottom", "-bottom-left", "-left", "-top-left", ...customs] },
	{ include: ["-center", "-top", "-right", "-bottom", "-left"], exclude: ["-down", "-end", "-footer"], regex: ["-center", "-top", "-top-", "-right", "-right-", "-bottom", "-bottom-", "-left", "-left-"] },
	{ include: ["-stretch"], exclude: [], regex: ["-initial", "-auto", "-both", "-around", "-baseline", "-between", "-evenly", "-normal", "-stretch", "-start", "-center", "-end"] },
	...
	{ include: ["-header", "-footer"], exclude: ["-right", "-down", "-bottom", "-end"], regex: ["-header", "-header-", "-center", "-footer", "-footer-"] },
	{ include: ["-header-", "-footer-"], exclude: ["-header", "-footer"], regex: ["-header-", "-footer-"] },
	{ include: ["-right", "-left"], exclude: ["-down", "-bottom", "-end", "-footer"], regex: ["-right", "-right-", "-center", "-left", "-left-"] },
	{ include: ["-right-", "-left-"], exclude: ["-right", "-left"], regex: ["-right-", "-left-"] },
	{ include: ["-up", "-down"], exclude: ["-bottom", "-end", "-footer", "-right"], regex: ["-up", "-up-", "-center", "-down", "-down-"] },
	{ include: ["-up-", "-down-"], exclude: ["-up", "-down"], regex: ["-up-", "-down-"] },
	{ include: ["-top", "-bottom"], exclude: ["-end", "-footer", "-right", "-down"], regex: ["-baseline", "-sub", "-super", "-top", "-top-", "-center", "-middle", "-bottom", "-bottom-"] },
	{ include: ["-top-", "-bottom-"], exclude: ["-top", "-bottom"], regex: ["-top-", "-bottom-"] },
	{ include: ["-start", "-end"], exclude: ["-footer", "-right", "-down", "-bottom"], regex: ["-start", "-start-", "-center", "-end", "-end-"] },
	{ include: ["-start-", "-end-"], exclude: ["-start", "-end"], regex: ["-start-", "-end-"] },
