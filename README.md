...
```fundamental
tailwindcss-class-sorter [subcommands] [options?] [globs?]
  ...
  format [options] [globs?]
    ...
    Options:
      ...
      --code-ext [string]
          ...
          - if set, "--code" flag must be set
      --config [string]
          - see https://github.com/LetsZiggy/tailwindcss-class-sorter/blob/main/tailwindcss-class-sorter/dist/config.json
...
## Config ([example](https://github.com/LetsZiggy/tailwindcss-class-sorter/blob/main/tailwindcss-class-sorter/dist/config.json))
...
`custom` order type uses `custom_order` below instead of an order from [order_list.json](https://github.com/LetsZiggy/tailwindcss-class-sorter/blob/main/tailwindcss-class-sorter/dist/order_list.json).

### edit_order

Edit selected order list (can also work with `"order_type": "custom"`). Run `tailwindcss-class-sorter list` to get the current groups' indices.
...
`group_index` is used instead of `group_name` is because `group_name` may repeat (eg. `content` group_name in [`recess` list](https://github.com/LetsZiggy/tailwindcss-class-sorter/blob/main/tailwindcss-class-sorter/dist/order_list.json)).
...
`group_name` is usually the first common word of the class names. `group_name` excludes prefixes starting with `!` | `-` | `no-` | `not-` | `min-` | `max-` | `auto-` (eg. `sr` group_name in [`recess` list](https://github.com/LetsZiggy/tailwindcss-class-sorter/blob/main/tailwindcss-class-sorter/dist/order_list.json)).
...
`group_name` may repeat (eg. `content` group_name in [`recess` list](https://github.com/LetsZiggy/tailwindcss-class-sorter/blob/main/tailwindcss-class-sorter/dist/order_list.json)).
