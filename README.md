...
```javascript
{
	 ...
	 * 		"conditional_split_character": Character used after condition expression in ternary operator (if/else) in templating engine
	 ...
	 * 	"conditional_split_character" is required if classes are dynamically added through ternary expression by templating engine
